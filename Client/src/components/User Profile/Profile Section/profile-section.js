...
let Profile_Section = () => {
  ...
  const InitialBanner = "/images/bck.jpeg";
                ...
                <div className="Profile-Section-Wrapper">                  
                    <div className="Profile-Top-Details-Section">
                      <div className="Profile-Banner-Outer-Wrapper">
                        <div className="Profile-Banner-Wrapper" style={{backgroundImage:`url(${ProfileBanner})`,backgroundSize:"cover",backgroundRepeat:"no-repeat" ,backgroundPositionX:"right"}}>
                          {
                            verifyUser && 
